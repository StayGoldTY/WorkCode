...
public class restfulDemoBuildLand {
    ...
    static final String appkey = "b2db1a1b548abdc21b7bbe75dc9aac70";
    static final String rid = "11460000008173790G@59";
    static final String sid = "s_2746000000000_14911";

    public restfulDemoBuildLand() {
    }
