...
public class restfulDemoBuildProject {
    ...
    static final String appkey = "2dccc0522811100bfb7f3fdff4cd91fb";
    static final String rid = "11460000008173790G@59";
    static final String sid = "s_2746000000000_14914";

    public restfulDemoBuildProject() {
    }
